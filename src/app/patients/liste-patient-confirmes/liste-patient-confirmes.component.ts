...
import {TableUtil} from "../liste-patient-confirmes/tableUtil";

@Component({
  selector: 'app-liste-patient-confirmes',
  templateUrl: './liste-patient-confirmes.component.html',
  styleUrls: ['./liste-patient-confirmes.component.scss']
})
export class ListePatientConfirmesComponent implements OnInit {
  search:string;
  ...
  exportTable(){
    TableUtil.exportToExcel("ListePatientsConfirmesTable");
  }
