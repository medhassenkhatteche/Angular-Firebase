...
import {TableUtil} from "../liste-patient-recdemini/tableUtil";

@Component({
  selector: 'app-liste-patient-recdemini',
  templateUrl: './liste-patient-recdemini.component.html',
  styleUrls: ['./liste-patient-recdemini.component.scss']
})
export class ListePatientRecdeminiComponent implements OnInit {
  ...
  load()  {
    this.patientApi.GetPatientList()
      ...
      patients.forEach(item => {
        ...
        a['$key'] = item.key;
        if(a['etape'] =='Réception de demande initiale'){
  ...
  exportTable(){
    TableUtil.exportToExcel("ListePatientsRecdeminiTable");
  }
