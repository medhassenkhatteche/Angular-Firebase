...
import {TableUtil} from "../liste-patient-classes/tableUtil";

@Component({
  selector: 'app-liste-patient-classes',
  templateUrl: './liste-patient-classes.component.html',
  styleUrls: ['./liste-patient-classes.component.scss']
})
export class ListePatientClassesComponent implements OnInit {
  search:string;
  ...
  exportTable(){
    TableUtil.exportToExcel("ListePatientsClassesTable");
  }
