...
import {TableUtil} from "../liste-patient-recpho/tableUtil";

@Component({
  selector: 'app-liste-patient-recpho',
  templateUrl: './liste-patient-recpho.component.html',
  styleUrls: ['./liste-patient-recpho.component.scss']
})
export class ListePatientRecphoComponent implements OnInit {
  ...
  load()  {
    this.patientApi.GetPatientList()
      ...
      patients.forEach(item => {
        ...
        a['$key'] = item.key;
        if(a['etape'] =='Réception des photos'){
  ...
  exportTable(){
    TableUtil.exportToExcel("ListePatientsRecphoTable");
  }
