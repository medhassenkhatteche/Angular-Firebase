...
import {TableUtil} from "../liste-patient-preconfirmes/tableUtil";

@Component({
  selector: 'app-liste-patient-preconfirmes',
  templateUrl: './liste-patient-preconfirmes.component.html',
  styleUrls: ['./liste-patient-preconfirmes.component.scss']
})
export class ListePatientPreconfirmesComponent implements OnInit {
  ...
  load()  {
    this.patientApi.GetPatientList()
      ...
      patients.forEach(item => {
        ...
        a['$key'] = item.key;
        if(a['etape'] =='Préconfirmation (date fixée)'){
  ...
  exportTable(){
    TableUtil.exportToExcel("ListePatientsPreconfirmesTable");
  }
